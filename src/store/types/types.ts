import { ProductsInCategoryAction } from './../actions/ProductsInCategoryAction';
...
export interface ProductsInCategoryState {
...
export interface AppState {
  ...
  productsInCategory: ProductsInCategoryState;
}
